...
#ToolsObject.convertDFToCsv('C:/Users/jeroa/Documents/ProofOfConcepts/test/users_test_2-3.csv', objectCleaner.mergeRowsOfOneDataFrame(0,'DNI', 'ID3', 'EXTID', 'A23'))
...
#ToolsObject.convertDFToCsv('C:/Users/jeroa/Documents/ProofOfConcepts/test/new_users_test_2.csv', objectCleaner2.mergeRowsOfDataFrames('DNI'))
